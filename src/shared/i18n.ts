...
const VI = {
  ...
  "popup.settings.summary": "Tùy chọn nâng cao",
...
const EN: Record<MessageKey, string> = {
  ...
  "popup.settings.summary": "Advanced options",
  "popup.settings.intro": "These options are stored on this device and applied to new captures.",
  ...
  "popup.settings.resetDone": "Default options restored. Current capture data was not changed.",
