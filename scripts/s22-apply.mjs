...
const payloadPath = "scripts/s22-apply.mjs.gz.b64";
const runtimePath = ".s22-apply-runtime.mjs";
const encoded = (await readFile(payloadPath, "utf8")).trim();
const checksum = createHash("sha256").update(encoded).digest("hex");
if (encoded.length !== 30_208 || checksum !== "151f887e950f3460698df60e40f1550d87fe870c46e5693612eb099f22fcf311") {
